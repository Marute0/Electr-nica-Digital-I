...
lsr_A_res lsr0 ( 
    .clk (clk), .A_bcd (A_bcd), .ones_comp2 (w_ones_comp2), .tens_comp2 (w_tens_comp2), .hundreds_comp2 (w_hundreds_comp2), .LD0 (load_reset), .LD1 (load_ones), .LD2 (load_tens), .LD3 (load_hundreds), .SH (shift), //Entrada
    .bcd_ones (w_bcd_ones), .bcd_tens (w_bcd_tens), .bcd_hundreds (w_bcd_hundreds), .A_bin (A_bin) //Salida
);
